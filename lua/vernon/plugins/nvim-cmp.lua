return {
  ...
  dependencies = {
    ...
    "rafamadriz/friendly-snippets", -- useful snippets for TS, JS, Go, Rust, etc.
  ...
  config = function()
    ...
    cmp.setup({
      ...
      mapping = cmp.mapping.preset.insert({
        ...
        -- Jump backward through snippet placeholders with Shift-Tab
      ...
      sources = cmp.config.sources({
        { name = "nvim_lsp" }, -- LSP completions (TS, Go, Rust)
